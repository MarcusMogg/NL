...
void Logger::Impl::formatTime()
{
    ...
    time_t seconds = static_cast<time_t>(microSecondsSinceEpoch / Timestamp::usPerSecond);
    int microseconds = static_cast<int>(microSecondsSinceEpoch % Timestamp::usPerSecond);
